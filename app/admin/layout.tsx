    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-64 bg-gray-900 text-white flex flex-col">
        ...
        <div className="p-4 border-t border-gray-800 space-y-2">
          <Button asChild className="w-full justify-start bg-indigo-600 hover:bg-indigo-700 rounded-xl">
            <Link href="/admin/competitions/create">
              <Plus className="w-4 h-4 mr-2" />
              Nouvelle compétition
            </Link>
          </Button>
          <Button asChild variant="outline" className="w-full justify-start text-gray-300 border-gray-700 hover:bg-gray-800 rounded-xl">
