...
export const competitionSchema = z.object({
  ...
  votePrice: z
    .number()
    .min(50, "Le prix minimum est 50 FCFA")
    .max(1000, "Le prix maximum est 1000 FCFA"),
...
/* export const playerSchema = z.object({
  ...
  competitionId: z.string().min(1, "Le competitionId est requis"),
...
export const voteSchema = z.object({
  ...
  customerPhone: z
    ...
    .regex(/^(\+221)?[0-9]{8,9}$/, "Format de numéro sénégalais invalide"),
});
